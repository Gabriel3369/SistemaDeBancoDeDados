...
CREATE TABLE itens_venda (
    ...
    bairro_entrega TEXT, /* eu acredito que seja text, pois entreas opções essa parece a melhor, guardar o texto do endereço do cliente*/
    produto_id INTEGER NOT NULL,
    produto_nome TEXT NOT NULL,
    categoria TEXT NOT NULL,
    unidade TEXT NOT NULL,
    quantidade INTEGER NOT NULL, /* eu acredito que seja integer, um numero inteiro*/
    valor_unitario NUMERIC(10, 2) NOT NULL  /* eu acredito que seja o numeric, pois é o Preço de uma unidade de medida*/
);
...
(3017, '2026-08-08', NULL, 10, 'Alface crespa', 'Legume','UN', 2.000, 3.49),
